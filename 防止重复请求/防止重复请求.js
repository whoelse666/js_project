/* 
img url :https://mmbiz.qpic.cn/sz_mmbiz_jpg/mshqAkialV7HbBMBo1UQhiaDibOA99T5hOYM5S46mtUQACCPSP0wUFYXhHWRyyQk9tsBh7v0C2fwxtaRFfwy1EuRA/640?wx_fmt=other&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1
思路，仍然是拦截相同请求，但这次我们可不可以不直接把请求挂掉，而是对于相同的请求我们先给它挂起，等到最先发出去的请求拿到结果回来之后，把成功或失败的结果共享给后面到来的相同请求
*/
